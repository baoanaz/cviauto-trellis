 ...
 *
 * Run `cviauto mem help` for the full flag reference.
 */
...
function cmdHelp(): void {
  console.log(`cviauto mem — list/search Claude/Codex/OpenCode/Pi sessions
...
flags:
  ...
  --phase brainstorm|implement|all       extract: slice by Cviauto brainstorm windows
...
examples:
  cviauto mem list
  cviauto mem list --global --platform claude --since 2026-04-01
  cviauto mem search "session insight" --global
  cviauto mem extract 5842592d --grep memory
