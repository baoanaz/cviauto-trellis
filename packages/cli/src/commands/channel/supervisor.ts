 ...
 *
 * Run as: `cviauto channel __supervisor <channel> <worker> <config-path>`
 *
...
/**
 * Entry point invoked by `cviauto channel __supervisor <channel> <worker> <config>`.
 */
export async function runSupervisor(
  ...
  // Self-pid file lets `cviauto channel kill` find us.
