/**
 * `cviauto channel rm <name>` — kill any live workers, then remove the
 * channel directory under `~/.cviauto/channels/`.
 *
 * `cviauto channel prune [--all | --idle <duration> | --empty]` — bulk
