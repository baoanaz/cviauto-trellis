 ...
 * - commands/cviauto/ — start + finish-work as TOML slash commands
 * - .agents/skills/cviauto-{name}/SKILL.md — auto-triggered shared skills
...
export async function configureGemini(cwd: string): Promise<void> {
  ...
  const commandsDir = path.join(configRoot, "commands", "cviauto");
