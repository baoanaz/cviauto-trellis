...
def resolve_task_dir(target_dir: str, repo_root: Path) -> Path:
    ...
    - Relative path: .cviauto/tasks/01-31-my-task
    ...
    # Relative path (contains path separator or starts with .cviauto)
    if "/" in normalized or normalized.startswith(".cviauto"):
...
if __name__ == "__main__":
    ...
    print(f"is_safe_task_path('.cviauto/tasks/test'): {is_safe_task_path('.cviauto/tasks/test', repo)}")
