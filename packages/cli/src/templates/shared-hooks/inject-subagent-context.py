...
AGENT_IMPLEMENT = "cviauto-implement"
AGENT_CHECK = "cviauto-check"
AGENT_RESEARCH = "cviauto-research"
LEGACY_AGENT_IMPLEMENT = "trellis-implement"
LEGACY_AGENT_CHECK = "trellis-check"
LEGACY_AGENT_RESEARCH = "trellis-research"

# Agents that require a task directory
AGENTS_REQUIRE_TASK = (
    AGENT_IMPLEMENT,
    AGENT_CHECK,
    LEGACY_AGENT_IMPLEMENT,
    LEGACY_AGENT_CHECK,
)
