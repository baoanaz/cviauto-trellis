...
- [ ] Update `.cviauto/spec/guides/` thinking guides
- [ ] Update `.cviauto/spec/backend/` or `frontend/` docs
...
2. **Sync templates** - After updating `.cviauto/spec/`, sync to `src/templates/markdown/spec/`
