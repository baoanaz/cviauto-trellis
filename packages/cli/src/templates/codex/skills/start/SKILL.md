...
Initialize a Cviauto-managed development session. This platform has no active session-start hook, so manually load the equivalent compact context by following these steps.
