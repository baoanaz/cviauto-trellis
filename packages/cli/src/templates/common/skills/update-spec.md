...
- `{{CMD_REF:update-spec}}` - Proposes and makes spec updates after user confirmation
- `{{CMD_REF:finish-work}}` - Can route here when the user explicitly asks to promote a lesson into spec
