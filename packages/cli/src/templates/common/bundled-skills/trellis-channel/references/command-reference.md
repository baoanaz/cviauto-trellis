...
cviauto channel send T --as A --text-file /tmp/message.md
```
...
```bash
cviauto channel thread <name> <thread-key>
  [--scope project|global]
  [--raw]
