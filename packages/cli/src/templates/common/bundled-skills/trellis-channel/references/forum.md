...
cviauto channel post design-feedback comment \
  --scope global \
  --as reviewer \
  --thread login-empty-state \
  --text-file /tmp/review.md

cviauto channel post design-feedback status \
  --scope global \
  --as main \
  --thread login-empty-state \
  --status closed

cviauto channel post design-feedback summary \
  --scope global \
  --as main \
  --thread login-empty-state \
...
cviauto channel forum design-feedback --scope global --status open
cviauto channel thread design-feedback login-empty-state --scope global
...
cviauto channel post release-notes opened \
  --scope global \
  --as main \
