---
description: "Cviauto Copilot prompt: Cross-Layer Check"
---
...
> **Note**: This is a **post-implementation** safety net. Ideally, read the [Pre-Implementation Checklist](.cviauto/spec/guides/pre-implementation-checklist.md) **before** writing code.
...
|----------|---------|--------|
| [Pre-Implementation Checklist](.cviauto/spec/guides/pre-implementation-checklist.md) | Questions before coding | **Before** writing code |
| [Code Reuse Thinking Guide](.cviauto/spec/guides/code-reuse-thinking-guide.md) | Pattern recognition | During implementation |
...
**Detailed Guide**: `.cviauto/spec/guides/cross-layer-thinking-guide.md`
...
**Detailed Guide**: `.cviauto/spec/guides/code-reuse-thinking-guide.md`
