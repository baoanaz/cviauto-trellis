---
description: "Cviauto Copilot prompt: Update Code-Spec - Capture Executable Contracts"
---
...
- `/` - Proposes and makes spec updates after user confirmation (this command)
- `/` - Can route here when the user explicitly asks to promote a lesson into spec
