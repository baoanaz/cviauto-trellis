...
describe("runMem subcommand integration", () => {
        ...
        message: {
          ...
          content: [
            { type: "text", text: "creating task" },
            {
              ...
              input: {
                command:
                  "python3 ./.cviauto/scripts/task.py create --slug demo",
              },
            },
          ],
        },
        ...
        message: {
          ...
          content: [
            { type: "text", text: "starting" },
            {
              ...
              input: {
                command:
                  "python3 ./.cviauto/scripts/task.py start .cviauto/tasks/demo",
              },
            },
          ],
        },
  ...
  it("help command prints usage", () => {
    runMem(["help"]);
    const joined = logs.join("\n");
    expect(joined).toContain("cviauto mem");
    expect(joined).toContain("claude|codex|opencode|all");
  });
