...
| Change when specs should be updated | Phase 3.3 in `.trellis/workflow.md` and the `trellis-update-spec` skill. Default native workflow runs this only when the user explicitly asks to promote knowledge into spec. |
